        ...
        <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3 leading-snug">
                     ...
                     <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
                        Dr. Tri Wismiarsi's initiative to empower women in coastal communities through value-added processing skills.
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all duration-300 group">
                ...
                <div className="p-6">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
                        Coverage by Antara TV on the entrepreneurship training program for coastal residents facilitated by Australia Global Alumni.
                    </p>
                </div>
            </div>
